...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("MOCHI KING Premium Scripts") then
			makefolder("MOCHI KING Premium Scripts")
		end
		if not isfolder("MOCHI KING Premium Scripts/Blox Fruits/") then
			makefolder("MOCHI KING Premium Scripts/Blox Fruits/")
		end
		if not isfile("MOCHI KING Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("MOCHI KING Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("MOCHI KING Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("MOCHI KING Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
elseif placeId == 7449423635 then
	...
	game.Players.LocalPlayer:Kick("No support map kub")
end
...
function WebHookLog:WebHookKaiTanSend(WebHookUrl)
	...
	local Embeds = {{
		["title"] = "**MOCHI KING Webhooks Status**",
